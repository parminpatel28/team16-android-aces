...
- Taylor Smith is our team lead, and is responsible for coordinating the project.
- Parmin Patel is responsible for merging code into main branch and producing product releases.
- Elaine Han is responsible for the front-end design and features.
- Mathhew Zhang is responsible for the database and backend design.
